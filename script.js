...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Hobbies data
    const hobbies = [
        { title: 'Playing guitar', icon: 'fa-guitar', description: 'Make a sound when im sad and boring' },
        { title: 'Singing', icon: 'fa-microphone', description: 'Enjoying sining when im alone and taking a bath' },
        { title: 'Playing Games', icon: 'fa-gamepad', description: 'Creating a friendship when im playing' },
        
    ];

    // Skills data - Updated to match your experience
    const skills = [
        { name: 'guitar', level: 85, icon: 'fa-guitar' },
        { name: 'Singing', level: 70, icon: 'fa-microphone' },
        { name: 'JavaScript', level: 50, icon: 'fa-js' },
        { name: 'HTML', level: 50, icon: 'fa-html5' },
        { name: 'CSS', level: 50, icon: 'fa-css3-alt' }
    ];
            ...
            <div class="md:w-1/2">
                ...
                <div class="space-y-4">
                    <div class="flex items-center">
                        ...
                        <span>chandlerperalta@example.com</span>
                    </div>
                    <div class="flex items-center">
                        <i class="fas fa-map-marker-alt text-cyan-400 mr-4"></i>
                        <span>Bebe Anac, Masantol, Pampanga, Philippines</span>
                    </div>
                </div>
                <div class="mt-8">
